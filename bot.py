...
def add_photos():
    for i in os.listdir('/Users/alex/memes/memesworldclass'):
        photo_handler(photo='/Users/alex/memes/memesworldclass/' + i)  # you have to change the path


def add_rusphotos():
    for j in os.listdir('/Users/alex/memes/pcixoff'):
        photo_handler(photo='/Users/alex/memes/pcixoff/' + j, lang='rus')  # you have to change the path
...
def set_lange(message):
    ...
    btn3 = types.InlineKeyboardButton(text='Both🇷🇺🇬🇧', callback_data='oba')
...
def callback(call):
    ...
    if call.data == 'inglish':
        ...
        bot.delete_message(call.message.chat.id, call.message.message_id)
        set_lang.clear()
        set_lang.extend(['Russian', 'English'])
